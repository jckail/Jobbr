...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "specified_context_ids", postgresql.ARRAY(sa.String()), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "source_type", sa.Enum("FILE", "OBJECT", name="sourcetype"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "event_type",
            sa.Enum(
                "CREATE", "CHAT", "FUNCTION", "KILL", "CONTEXT", name="aieventtype"
            ),
            nullable=False,
        ),
        sa.Column(
        ...
        sa.Column(
            "event_status",
            sa.Enum("STARTED", "RUNNING", "FAILED", "COMPLETED", name="aieventstatus"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "genre",
            sa.Enum("ROCK", "ELECTRONIC", "METAL", "HIP_HOP", name="genreurlchoices"),
            nullable=False,
        ),
        sa.Column("id", sqlmodel.sql.sqltypes.GUID(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "team_description", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        ...
        sa.Column(
            "programming_languages", postgresql.ARRAY(sa.String()), nullable=True
        ),
        ...
        sa.Column(
            "estimated_career_level", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column(
            "education_requirement", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column(
            "compensation_type", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        ...
        sa.Column(
            "pto_and_benefits", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        ...
        sa.Column(
            "estimated_status", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "parseVisibleTextPath", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
